 ...
 */
public class TbMicAutores implements java.io.Serializable {
	...
	public TbMicAutores(int nbIdautor, int nbPais) {
		this.nbIdautor = nbIdautor;
		this.nbPais = nbPais;
	}

	public TbMicAutores(int nbIdautor, String vrNombres,
