 ...
 */
public class TbMicTemas implements java.io.Serializable {
	...
	public TbMicTemas(int nbIdtema, String vrDescripcion, String vrModusuario,
			Date dtModfecha) {
		super();
	...
	public TbMicTemas(int nbIdtema, String vrDescripcion,
