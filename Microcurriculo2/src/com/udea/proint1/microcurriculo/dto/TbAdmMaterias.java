 ...
 */
public class TbAdmMaterias implements java.io.Serializable {
	...
	private Set tbMicMicrocurriculoses = new HashSet(0);
	...
	public TbAdmMaterias() {
	}

	public TbAdmMaterias(String vrIdmateria, TbAdmNucleo tbAdmNucleo,
			int nbSemestre) {
	...
	public TbAdmMaterias(String vrIdmateria, TbAdmNucleo tbAdmNucleo,
			...
			int blEstado, Set tbMicMicrocurriculoses,
		...
		this.tbMicMicrocurriculoses = tbMicMicrocurriculoses;
	...
	public Set getTbMicMicrocurriculoses() {
		return this.tbMicMicrocurriculoses;
	}

	public void setTbMicMicrocurriculoses(Set tbMicMicrocurriculoses) {
		this.tbMicMicrocurriculoses = tbMicMicrocurriculoses;
	}
